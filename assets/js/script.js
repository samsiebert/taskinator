...
var taskFormHandler = function(event) {
    ...
    //check if task is new or one being edited by seeing if it has a dta-task-id attribute
...
var loadTasks = function () {
    ...
    console.log(tasks);
    //itterate through a tasks array and creates task elements on the page from it
  for (var i=0; i < tasks.length; i++) {
